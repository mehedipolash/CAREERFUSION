  ...
  const values = [
    {
      icon: "🎯",
      title: "Our Mission",
      description: "To bridge the gap between talented professionals and innovative companies, creating meaningful career connections that drive growth and success."
    },
    {
      icon: "👁️",
      title: "Our Vision",
      description: "A world where everyone finds fulfilling work and every company discovers the perfect talent to achieve their goals."
    },
    {
      icon: "💎",
      title: "Our Values",
      description: "Transparency, innovation, and commitment to excellence guide every interaction on our platform."
    }
  ];
        ...
        <div className="relative max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl md:text-2xl text-gray-600 max-w-4xl mx-auto leading-relaxed">
              We're revolutionizing the way professionals connect with career opportunities. 
              Our AI-powered platform matches talent with dream jobs, creating perfect career symphonies.
            </p>
          </motion.div>
        </div>
      </section>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <div className="space-y-4 text-lg text-gray-600 leading-relaxed">
                <p>
                  Founded in 2018, CareerFusion emerged from a simple observation: 
                  the job search process was broken. Candidates felt lost in a sea of applications, 
                  while companies struggled to find the right talent.
                </p>
                <p>
                  We set out to create a platform that uses cutting-edge technology to understand 
                  both job seekers' aspirations and employers' needs, creating meaningful matches 
                  that benefit everyone.
                </p>
                <p>
                  Today, we're proud to be the fastest-growing career platform, trusted by 
                  professionals and companies worldwide to create career magic.
                </p>
              </div>
            </motion.div>
            ...
            >
              <div className="bg-linear-to-br from-blue-500 to-purple-600 rounded-2xl p-8 text-white">
                ...
                <p className="text-blue-100 leading-relaxed">
                  ...
                  personalized recommendations, and smart matching algorithms 
                  to ensure you always have the competitive edge.
                </p>
              </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          >
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Our core principles shape every feature and interaction on CareerFusion
            </p>
          </motion.div>
        ...
        <div className="max-w-4xl mx-auto px-4 text-center">
          ...
          >
            ...
            <p className="text-xl text-blue-100 mb-8 max-w-2xl mx-auto">
              Join millions of professionals who've found their dream jobs through CareerFusion
            </p>
